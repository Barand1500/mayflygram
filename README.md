...
│   ├── data/
│   │   ├── fakeNotifications.js  # Notification dummy data
│   │   ├── fakePosts.js          # Post dummy data
│   │   ├── fakeStories.js        # Story dummy data
│   │   └── fakeVideos.js         # Video dummy data
│   ├── App.jsx                   # Main app component
│   ├── App.css                   # App styles (light + dark)
...
- **Dark Mode** - #121212 background with smooth transitions
- **Light Mode** - #fafafa background with soft shadows
- Soft color palette
...
- **Pravatar** - Avatar images
- **Google Cloud Storage** - Sample videos

## ⚡ Performance Optimizations

- **React.memo** - Memoized components (Post, StoryBar, VideoPlayer, NotificationItem)
- **Lazy Loading** - Videos load only when visible
- **Scroll-based activation** - Videos play only when in view
- **LocalStorage caching** - Theme preference saved
- **Minimal re-renders** - Optimized state updates
- **Lightweight codebase** - No heavy dependencies
...
- Event handling & lifecycle hooks
- Conditional rendering
- Props and data flow
- CSS theming & transitions
- localStorage integration
- Advanced React patterns (memo, custom hooks)
- Video handling & scroll events
- Smart bot logic with emotion detection

---

# Instagram Clone 📱

React ve Vite ile oluşturulmuş modern, özellik zengin Instagram benzeri web uygulaması.

## 🌟 Özellikler

### 🎨 Tema Sistemi
- **Dark/Light Mode** - Kalıcı localStorage ile temalar arası geçiş
- Tüm componentlerde yumuşak geçişler
- Modern dark tema (#121212) ve temiz light tema

### 🏠 Ana Sayfa / Feed
- Modern Instagram benzeri arayüz
- **Story Bar** - Tam ekran görüntüleyici ile 8 interaktif hikaye
- Hikayeler 4 saniye sonra otomatik kapanır
- Unsplash'ten örnek gönderiler ve resimler
- **Çift tıklama beğeni** animasyonu ile kalp efekti
- Gerçek zamanlı sayaç ile interaktif beğeni sistemi
- **Yorum Sistemi** - Modal arayüzü ile yorumları görüntüle ve ekle

### 💬 Mesajlar (Yapay Zeka Destekli Bot)
- WhatsApp/Instagram DM tarzı sohbet arayüzü
- **Akıllı AI Bot** gelişmiş özelliklerle:
  - **Duygu Tespiti** - Üzgün/mutlu kelimelere yanıt verir
  - **Bot Kişiliği** - Rastgele kişilik mesajları (%20 ihtimal)
  - **Konu Değiştirme Tespiti** - 5 mesajdan sonra konu değişikliği önerir
  - **Yazıyor Animasyonu** - Gerçekçi "yazıyor..." göstergesi
  - **Hareketsizlik Yanıtı** - 10s sessizlik sonrası mesaj gönderir
  - **Zaman Damgaları** - Her mesajda saat gösterir
- Kullanıcı/bot ayrımı ile mesaj balonları
- Mesaj göndermek için Enter tuşu desteği

### 🎬 Reels
- **TikTok/Instagram Reels tarzı** tam ekran dikey video akışı
- Otomatik oynatma ile 5 örnek video
- Kaydırma tabanlı video geçişi
- **Çift tıklama beğeni** animasyonu
- Dikey aksiyon butonları (Beğen, Yorum, Paylaş)
- Kaydırılınca video durur

### 🔔 Bildirimler
- Kapsamlı bildirim sistemi
- 8 bildirim türü (beğeniler, takipler, mesajlar, yorumlar)
- Takip bildirimleri için **Takip Et** butonu
- **Okunmamış göstergesi** - Tab ikonunda kırmızı nokta
- Açılınca otomatik okundu işaretlenir
- Zaman damgaları (5d, 1s, 2g formatı)

### 👤 Profil
- **Kapak Fotoğrafı** - Üstte banner resmi
- İstatistiklerle profil avatarı
- Çok satırlı bio desteği
- Güncel istatistikler (24 Gönderi, 120 Takipçi, 87 Takip)
- **Hikaye Öne Çıkanları** - 3 öne çıkan daire (Seyahat, Kodlama, Yaşam)
- **Profili Düzenle** butonu
- Fotoğraf grid düzeni (6 fotoğraf)
- Responsive tasarım

### ⚙️ Ayarlar
- **Profil Ayarları** - Kullanıcı adı ve bio düzenle
- **Tema Değiştirici** - Light/dark mode arası geçiş
- **Bildirim Tercihleri** - Push ve email ayarları
- **Çıkış** butonu
- Temiz bölümlenmiş arayüz

### 📱 Tab Navigasyonu
- 5 tab ile alt navigasyon çubuğu
- Ana Sayfa, Reels, Ekle/Ayarlar, Bildirimler, Mesajlar
- Instagram tarzı ikonlar
...
### Duygu Tespiti
| Kullanıcı Girişi | Bot Yanıtı |
|------------------|------------|
| "kötü", "üzgün", "moral" | "Üzüldüm bak buna... biraz konuşmak ister misin? 🥺" |
| "harika", "iyi", "mükemmel" | "Ayy mükemmel! Böyle vibe'ları seviyorum 😄🔥" |
| "selam", "merhaba" | "Selam! Nasılsın? 😊" |
| "yardım", "help" | "Tabii, nasıl yardımcı olabilirim? 💡" |
| "kimsin" | "Ben test için yapılmış bir botum 🤖" |
| "foto", "photo" | "Fotoğraf şu an mevcut değil 📷" |
| "nasılsın" | "İyiyim! Sen nasılsın? 😄" |

### Bot Kişiliği (%20 ihtimal)
- "(bunu kimseye söyleme ama seni seviyorum 🤫🤖)"
- "(şu an sistem loglarımı siliyorum, geliyorum 😂)"
- "(yemin ederim en iyi kullanıcı sensin)"

### Akıllı Davranışlar
- **3 ardışık mesaj** → "Vay, bugün çok konuşkansın 😂"
- **Aynı konuda 5 mesaj** → "Şöyle bi konu değişikliği yapalım mı? 😄"
- **10 saniye hareketsiz** → "Burada mısın? 😄"
...
├── src/
│   ├── components/
│   │   ├── CommentModal.jsx      # Gönderiler için yorum modali
│   │   ├── NotificationItem.jsx  # Tekil bildirim bileşeni
│   │   ├── Post.jsx              # Beğeni/yorum ile gönderi bileşeni
│   │   ├── StoryBar.jsx          # Yatay hikaye listesi
│   │   ├── StoryViewer.jsx       # Tam ekran hikaye görüntüleyici
│   │   ├── TabBar.jsx            # Alt navigasyon çubuğu
│   │   ├── ThemeSwitcher.jsx     # Tema değiştirme butonu
│   │   └── VideoPlayer.jsx       # Reels video oynatıcı
│   ├── screens/
│   │   ├── Home.jsx              # Hikayelerle Feed/Ana sayfa
│   │   ├── Messages.jsx          # AI bot ile sohbet arayüzü
│   │   ├── Notifications.jsx     # Bildirimler listesi
│   │   ├── Profile.jsx           # Kullanıcı profil sayfası
│   │   ├── Reels.jsx             # Dikey video akışı
│   │   └── Settings.jsx          # Ayarlar sayfası
│   ├── context/
│   │   └── ThemeContext.jsx      # Tema sağlayıcı ve context
│   ├── data/
│   │   ├── fakeNotifications.js  # Bildirim dummy datası
│   │   ├── fakePosts.js          # Gönderi dummy datası
│   │   ├── fakeStories.js        # Hikaye dummy datası
│   │   └── fakeVideos.js         # Video dummy datası
│   ├── App.jsx                   # Ana uygulama bileşeni
│   ├── App.css                   # Uygulama stilleri (light + dark)
...
- Temiz, modern arayüz
- **Dark Mode** - Yumuşak geçişlerle #121212 arka plan
- **Light Mode** - Yumuşak gölgelerle #fafafa arka plan
- Yumuşak renk paleti
- Yuvarlak köşeler ve akıcı geçişler
- Instagram'dan esinlenilmiş UI/UX
- Tamamen responsive tasarım
- Mobil uyumlu

## 🛠️ Teknolojiler

- **React 18** - Hooks ile UI kütüphanesi
- **Vite** - Build aracı ve geliştirme sunucusu
- **Context API** - Tema state yönetimi
- **CSS3** - Dark mode desteği ile stil
- **localStorage** - Tema kalıcılığı
- **Unsplash** - Stok fotoğraflar
- **Pravatar** - Avatar resimleri
- **Google Cloud Storage** - Örnek videolar

## ⚡ Performans Optimizasyonları

- **React.memo** - Memoize edilmiş componentler (Post, StoryBar, VideoPlayer, NotificationItem)
- **Lazy Loading** - Videolar sadece görünür olduğunda yüklenir
- **Scroll tabanlı aktivasyon** - Videolar sadece görünümdeyken oynar
- **LocalStorage önbellekleme** - Tema tercihi kaydedilir
- **Minimal re-render** - Optimize state güncellemeleri
- **Hafif kod tabanı** - Ağır bağımlılık yok

## 📱 Responsive Tasarım

Uygulama şu cihazlarda sorunsuz çalışır:
...
- useState ve Context API ile state yönetimi
- Olay yönetimi ve lifecycle hooks
- Koşullu render
- Props ve veri akışı
- CSS temalama ve geçişler
- localStorage entegrasyonu
- Gelişmiş React kalıpları (memo, custom hooks)
- Video yönetimi ve scroll olayları
- Duygu tespiti ile akıllı bot mantığı
